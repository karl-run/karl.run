import header from '../../posts/spring-boot-schema-first-graphql/header.png';
import graphiql from '../../posts/spring-boot-schema-first-graphql/graphiql.png';
import mutationResolve from '../../posts/spring-boot-schema-first-graphql/mutation-resolve.png';
import mutationStoredValue from '../../posts/spring-boot-schema-first-graphql/mutation-stored-value.png';
import resolveResolve from '../../posts/spring-boot-schema-first-graphql/resolve-resolve.png';
import objectResolve from '../../posts/spring-boot-schema-first-graphql/object-resolve.png';
import paramResolve from '../../posts/spring-boot-schema-first-graphql/param-resolve.png';
import query from '../../posts/spring-boot-schema-first-graphql/query.png';
...
<Image src={graphiql} alt="Example of GraphiQL execution" />
...
<Image src={query} alt="Example of GraphQL query" />
...
<Image src={objectResolve} alt="Example of GraphQL object resolving" />
...
<Image src={paramResolve} alt="Example of GraphQL parameter resolving" />
...
<Image src={resolveResolve} alt="Example of GraphQL value resolving" />
...
<Image src={mutationResolve} alt="Example of GraphQL mutation" />

Now have a fully functional API with both reading and writing!

<Image src={mutationStoredValue} alt="Example of GraphQL stored value query" />
